//! This crate provides `RunningAverage` and `RealTimeRunningAverage` types that provide facility to calculate running averages with specified time windows width and using constant memory.
//! 
